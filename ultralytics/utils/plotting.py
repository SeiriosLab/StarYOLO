...
class Annotator:
    ...
    def __init__(self, im, line_width=None, font_size=None, font="Arial.ttf", pil=False, example="abc"):
        ...
        self.kpt_color = colors.pose_palette[[0, 16, 16, 16, 16, 0, 0, 0, 0, 0, 0, 9, 9, 9, 9, 9, 9]]
    ...
    def kpts(self, kpts, shape=(640, 640), radius=8, kpt_line=True):
        """
        ...
        for i, k in enumerate(kpts):
            ...
            if x_coord % shape[1] != 0 and y_coord % shape[0] != 0:
                if len(k) == 3:
                    ...
                    if conf < 0.5:
                        continue
                # cv2.circle(self.im, (int(x_coord), int(y_coord)), radius, [255,255,0], -1, lineType=cv2.LINE_AA)
                cv2.drawMarker(self.im, (int(x_coord), int(y_coord)), color=(255, 255, 0), markerType=cv2.MARKER_TILTED_CROSS, 
               markerSize=30, thickness=8, line_type=cv2.LINE_AA)
